...
namespace Client.WCF {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WCF.ISimplex")]
    public interface ISimplex {
        ...
        Client.WCF.A Sum(Client.WCF.A a1, Client.WCF.A a2);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISimplex/Sum", ReplyAction="http://tempuri.org/ISimplex/SumResponse")]
        System.Threading.Tasks.Task<Client.WCF.A> SumAsync(Client.WCF.A a1, Client.WCF.A a2);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISimplexChannel : Client.WCF.ISimplex, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SimplexClient : System.ServiceModel.ClientBase<Client.WCF.ISimplex>, Client.WCF.ISimplex {
        ...
        public Client.WCF.A Sum(Client.WCF.A a1, Client.WCF.A a2) {
            return base.Channel.Sum(a1, a2);
        }
        
        public System.Threading.Tasks.Task<Client.WCF.A> SumAsync(Client.WCF.A a1, Client.WCF.A a2) {
